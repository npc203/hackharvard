...
const Hero = () => {
  const { isOpen: isOpenCreate, onOpen: onOpenCreate, onClose: onClose } = useDisclosure();
  const { isOpenJoin, onOpenJoin, onCloseJoin } = useDisclosure();
