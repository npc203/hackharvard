...
export default function Home() {
  return (
    <div>
      ...
      <VStack
        w="100%"
        background="linear-gradient(-28deg, rgba(255, 122, 117, 1) 2%, rgba(255, 218, 217, 1) 35%, rgba(255, 218, 217, 1) 51%, rgba(255, 122, 117, 1) 98%, rgba(255, 122, 117, 1) 92%)"
